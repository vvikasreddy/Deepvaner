...
def demo():
    ...
    parser.add_argument('--gpu', '-g', default='False', help='Use gpu or not', type=str)
        ...
        for k in range(1, 11):
            if args.fusion == 'feature':
                train(modal=args.modal, dataset=args.dataset, epoch=args.epoch, lr=args.learn_rate, use_gpu=use_gpu,
                      ...
                      face_feature_size=args.face_feature_size, bio_feature_size=args.bio_feature_size,
                      pretrain=pretrain)
